        ...
        <div class="container-xl">
            <div class="row row-deck row-cards">
                <div class="col-sm-6 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="h3 mb-2">Common</div>
                            <div class="d-flex align-items-center">
                                <div class="subheader">
                                    <ol class="px-3">
                                        <li>Register page: Modal with redirect (Livewire)</li>
                                        <li>Profile: SweetAlert (Laravel Controller)</li>
                                        <li>Change password: Modal alert(Laravel controller)</li>
                                    </ol>
                                </div>
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="h3 mb-2">Employees</div>
                            <div class="d-flex align-items-center">
                                <div class="subheader">
                                    <ol class="px-3">
                ...
                <div class="col-sm-6 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <div class="h3 mb-2">Clients / Projects</div>
                            <div class="d-flex align-items-center">
                                <div class="subheader">
                                    <ol class="px-3">
                                        ...
                                        <li>Client: PayPal Payment Gateway (Pending)</li>
                                    </ol>
                                </div>
