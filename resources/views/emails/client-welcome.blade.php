                                                ...
                                                <tbody>
                                                  <tr>
                                                    <td align="center" class="bmeImage" style="border-collapse: collapse;padding-left:20px; padding-right: 20px;padding-top:20px; padding-bottom: 20px; ">
                                                      <img src="https://images.benchmarkemail.com/client597226/image13902953.png" width="109" style="max-width: 109px; display: block; border-radius: 0px;" alt="" data-radius="0" border="0" data-original-max-width="218" class="keep-custom-width" data-customwidth="50">
                                                    </td>
                                                  </tr>
                                                </tbody>
                                              </table>
                                                            ...
                                                            <td valign="top" align="left" name="tblCell" class="tblCell" style="padding: 10px 20px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; font-weight: 400; color: rgb(56, 56, 56); text-align: left; word-break: break-word;">
                                                              <div style="line-height: 150%; text-align: center;">
                                                                <span style="font-size: 30px;">
                                                                  <strong>
                                                                    <span style="line-height: 150%; color: rgb(255, 255, 255);">{{ $mailContent['body'] }}</span>
                                                                  </strong>
                                                                </span>
                                                              </div>
                                                            </td>
                                            ...
                                            <td>
                                              <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                <tbody>
                                                  <tr>
                                                    <td align="center" class="bmeImage" style="border-collapse: collapse;padding-left:20px; padding-right: 20px;padding-top:20px; padding-bottom: 20px; ">
                                                      <img src="https://images.benchmarkemail.com/client597226/image13903004.png" width="109" style="max-width: 109px; display: block; border-radius: 0px;" alt="" data-radius="0" border="0" data-original-max-width="218" class="keep-custom-width" data-customwidth="50">
                                                    </td>
                                                  </tr>
                                                </tbody>
                                              </table>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" name="blk_footer" class="blk">
  <tbody>
    <tr>
      <td align="center" style="padding: 20px; text-align: center;" name="tblCell">
        <span style="font-family: Arial, Helvetica, sans-serif; font-weight: normal; font-size: 12px;">This message was sent to by <br>
          <span href="https://benchmarkemail.benchmarkurl.com/c/su?e=163D8F8&c=91CEA&t=1&email=NyIeD9VsXLU%3D&relid=">
            <img src="https://ui.benchmarkemail.com/images/verified.png" alt="Unsubscribe from all mailings" title="Unsubscribe from all mailings" border="0">
          </span>
          <a class="bmefootertext" target="_new" href="https://benchmarkemail.benchmarkurl.com/c/su?e=163D8F8&c=91CEA&t=1&email=NyIeD9VsXLU%3D&relid=" style="color:inherit;text-decoration:underline;">Unsubscribe</a> | <a class="bmefootertext" target="_new" href="https://benchmarkemail.benchmarkurl.com/c/s?e=163D8F8&c=91CEA&t=1&email=NyIeD9VsXLU%3D&relid=" style="color:inherit;text-decoration:underline;">Manage Subscription</a>
          <br>5500 Bolsa Avenue, Suite 245, Huntington Beach, CA, 92649 <br>
          <a href="https://www.benchmarkemail.com?p=500289" target="_new">
            <img src="https://www.benchmarkemail.com/images/web4/misc/emailfooter/opt9.png" border="0">
          </a>
          <br>
        </span>
      </td>
...
<div align="center">
  <div style="font-size: 11px; text-align: left;">
    <table width="600" cellspacing=0 cellpadding=0 border=0 align="center" class="container-table">
      <tr>
        <td width="2%" valign=top style="padding-right: 4px;">
          <img align=absmiddle src='https://benchmarkemail.benchmarkurl.com/test_msg_star.gif' alt='' />
        </td>
        <td width="98%">
          <div style="font-family: Verdana,Arial,Helvetica,sans-serif; font-size:14px;color: #6f0708">
            <b>This is a Test Email only.</b>
          </div>
          <div style="padding-top: 1px;font-size:12px;font-family: Verdana,Arial,Helvetica,sans-serif;">This message was sent for the sole purpose of testing a draft message.</div>
        </td>
      </tr>
    </table>
  </div>
